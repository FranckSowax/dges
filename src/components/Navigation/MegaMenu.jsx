...
const MegaMenu = ({ data }) => {
  return (
    <motion.div
      ...
      className="absolute left-0 top-full mt-2 w-screen max-w-5xl -translate-x-1/3 bg-white rounded-card-lg shadow-2xl border border-neutral-gray-light overflow-hidden"
    >
      <div className="p-8">
